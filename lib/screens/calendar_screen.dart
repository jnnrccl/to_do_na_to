            ...
            child: Dismissible(
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                    '${_timeFormatter.format(task.date)} • ${task.priority}',
                    style: GoogleFonts.rubik(
                      color: Colors.indigo,
                      fontSize: 12.0,
                        ...
                        children: <Widget>[
                          TableCalendar(
                            ...
                            calendarStyle: CalendarStyle(
                              markersMaxAmount: 1,
                              markersColor: Colors.tealAccent.shade700,
                              eventDayStyle: GoogleFonts.rubik(color: Colors.indigo ,fontWeight: FontWeight.normal,fontSize: 14),
